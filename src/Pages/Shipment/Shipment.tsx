...
function createData(data: Partial<ShipmentModel>): ShipmentModel {
   return {
      ...
      miami: data.miami || 0,
      finalPriceInMiani: data.finalPriceInMiani || 0,
...
const headCells: readonly HeadCell[] = [
   ...
   {
      id: "finalPriceInMiani",
      numeric: true,
      disablePadding: false,
      label: "Final Price in Miani",
   },
   {
      id: "orderType",
      numeric: false,
