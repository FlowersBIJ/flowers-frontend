...
export const Shipment = observer(() => {
   ...
   const handleSelectAllClick = (
      ...
      if (event.target.checked) {
         const newSelected = shipmentStore.shipment.map((n) => n.id);
   ...
   const emptyRows =
      page > 0 ? Math.max(0, (1 + page) * rowsPerPage - shipmentStore.shipment.length) : 0;

   const visibleRows = React.useMemo(
      () =>
         stableSort(shipmentStore.shipment, getComparator(order, orderBy)).slice(
            page * rowsPerPage,
      ...
      <Box sx={{ width: "100%" }}>
         <Paper sx={{ width: "100%", mb: 2 }}>
            ...
            <TableContainer>
               ...
               >
                  <EnhancedTableHead
                     ...
                     rowCount={shipmentStore.shipment.length}
                  />
                  <TableBody>
            ...
            <TablePagination
               ...
               component="div"
               count={shipmentStore.shipment.length}
